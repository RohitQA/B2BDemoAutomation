...
public static void logout(){
			driver.findElement(By.xpath("//*[@id='header']/nav[1]/div/ul/li/button")).click();
			driver.findElement(By.xpath("//*[@id='header']/nav[1]/div/ul/li/ul/li[4]/a")).click();
			
			
		}
public static void deleteContacts() throws InterruptedException{
	driver.findElement(By.xpath("//*[@ng-click='toggle()']")).click();
	driver.findElement(By.xpath("//*[@ng-click='deleteContact()']")).click();
	Thread.sleep(3000L);
	driver.findElement(By.xpath("//button[@ng-class='options.okCls']")).click();
