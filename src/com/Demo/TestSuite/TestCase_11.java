...
// TEST CASE: Search on Company Details
...
public class TestCase_11 extends TestSuiteBase{
	...
	public void TestCase11() {
		...
		System.out.println("This is TestCase 11");
		APP_LOGS.debug(" Executing TestCase_11");
		try{
			driver.navigate().refresh();
		    driver.findElement(By.xpath("html/body/article/div/div/div[1]/div[7]/label/input")).click();
		    driver.executeScript("scroll,(0,400)");
			driver.findElement(By.xpath("//*[@id='s2id_autogen18']")).click();
			Thread.sleep(4000L);
			driver.findElement(By.xpath("//*[@id='select2-result-label-32']")).click();
