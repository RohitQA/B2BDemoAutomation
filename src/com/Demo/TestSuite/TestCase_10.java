...
public class TestCase_10 extends TestSuiteBase{
	...
	public void TestCase10() {
		System.out.println("This is TestCase10");
		count++;
		...
		System.out.println("This is TestCase 10");
		APP_LOGS.debug(" Executing TestCase_10");
		try{
			
			driver.navigate().refresh();
			driver.findElement(By.xpath("//*[@id='s2id_autogen16']")).sendKeys("co");
			Thread.sleep(5000L);
