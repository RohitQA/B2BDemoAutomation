...
// TEST CASE: Search on Personal Name
...
public class TestCase_13 extends TestSuiteBase{
	...
	public void TestCase13() {
		System.out.println("This is TestCase13");
		count++;
		...
		System.out.println("This is TestCase 13");
		APP_LOGS.debug(" Executing TestCase_13");
		try{
			driver.navigate().refresh();
		    driver.findElement(By.xpath("html/body/article/div/div/div[1]/div[9]/label/input")).click();
		    driver.executeScript("scroll(0,100)");
			driver.findElement(By.xpath("//*[@id='s2id_autogen26']")).sendKeys("stev");
			Thread.sleep(5000L);
