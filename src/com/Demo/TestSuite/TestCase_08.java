...
public class TestCase_08 extends TestSuiteBase{
	...
	public void TestCase08() {
		System.out.println("This is TestCase08");
		count++;
		...
		System.out.println("This is TestCase 08");
		APP_LOGS.debug(" Executing TestCase_08");
		try{
			driver.navigate().refresh();	
			driver.findElement(By.xpath("//*[@id='s2id_autogen6']")).sendKeys("quality");
			Thread.sleep(5000L);
